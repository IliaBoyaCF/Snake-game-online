...
internal class Master : Node
{
    ...
    public void Routine()
    {
        ...
        GameState sendingState = GetGameState(gameState);
        _context.SynchronizedOnNodes(_ =>
        {
    ...
    private GameState GetGameState(IGameState gameState)
    {
        ...
        {
            state.Foods.Add(new GameState.Types.Coord()
            {
    ...
    private GameState.Types.Snake GetSnake(ISnakeState snakeState)
    {
        GameState.Types.Snake snake = new GameState.Types.Snake()
        {
            State = snakeState.GetStatus() == ISnakeState.SnakeStatus.ALIVE ? GameState.Types.Snake.Types.SnakeState.Alive : GameState.Types.Snake.Types.SnakeState.Zombie,
        ...
        {
            snake.Points.Add(new GameState.Types.Coord()
            {
